...
int32_t EADC_Open(EADC_T *eadc, uint32_t u32InputMode)
{
    ...
    /* Start the EADC calibration function to decrease the effect of electrical random noise. */
...
void EADC_Calibration(EADC_T *eadc)
{
    ...
    g_EADC_i32ErrCode = EADC_ARG_ERR;
...
/**
  ...
  *                             - \ref EADC_BPWM2TG_TRIGGER             : BPWM2TG trigger
  *                             - \ref EADC_BPWM3TG_TRIGGER             : BPWM3TG trigger
  *                             - \ref EADC_BPWM4TG_TRIGGER             : BPWM4TG trigger
  *                             - \ref EADC_BPWM5TG_TRIGGER             : BPWM5TG trigger
  *                             - \ref EADC_ACMP0INT_TRIGGER            : ACMP0 interrupt trigger
  *                             - \ref EADC_ACMP1INT_TRIGGER            : ACMP1 interrupt trigger
  ...
  *             Sample module 16~18 is fixed for ADC channel 16, 17, 18 input sources as band-gap voltage, temperature sensor, and AVDD/4.
  */
...
/**
  ...
  *             rigger delay time = (u32TriggerDelayTime) x (Trigger delay clock period).
  */
