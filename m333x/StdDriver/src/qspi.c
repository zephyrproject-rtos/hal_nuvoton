 ...
 * @file     qspi.c
 * @version  V3.00
 * @brief    Quad Serial Peripheral Interface(QSPI) driver source file
 *
                   ...
                   uint32_t u32BusClock)
{
    ...
    if(u32MasterSlave == QSPI_MASTER)
    {
        ...
        if((qspi == QSPI0) || (qspi == QSPI0_NS))
        {
            ...
            else if((CLK_GetModuleClockSource(QSPI0_MODULE) << CLK_CLKSEL2_QSPI0SEL_Pos) == CLK_CLKSEL2_QSPI0SEL_PLL_DIV2)
            {
