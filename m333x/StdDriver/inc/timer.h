...
#define TIMER_INTER_CAPTURE_OFF                 (0xFFUL) /*!< Capture source from Tx_EXT pin \hideinitializer */
...
#define TIMER_EVENT_COUNTER_SOURCE_USB          (1UL << TIMER_EXTCTL_ECNTSSEL_Pos) /*!< Event Counter source from internal USB SOF output signal \hideinitializer */
