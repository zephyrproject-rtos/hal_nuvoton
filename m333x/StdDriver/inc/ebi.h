...
/**
  ...
  * \hideinitializer
  */
#define EBI0_READ_DATA8(u32Addr)                (*((volatile unsigned char *)(((EBI==EBI_S)? EBI_BANK0_BASE_ADDR:EBI_BANK0_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI0_WRITE_DATA8(u32Addr, u32Data)      (*((volatile unsigned char *)(((EBI==EBI_S)? EBI_BANK0_BASE_ADDR:EBI_BANK0_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
...
/**
  ...
  * \hideinitializer
  */
#define EBI0_READ_DATA16(u32Addr)               (*((volatile unsigned short *)(((EBI==EBI_S)? EBI_BANK0_BASE_ADDR:EBI_BANK0_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI0_WRITE_DATA16(u32Addr, u32Data)     (*((volatile unsigned short *)(((EBI==EBI_S)? EBI_BANK0_BASE_ADDR:EBI_BANK0_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
...
/**
  ...
  * \hideinitializer
  */
#define EBI0_READ_DATA32(u32Addr)               (*((volatile unsigned int *)(((EBI==EBI_S)? EBI_BANK0_BASE_ADDR:EBI_BANK0_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI0_WRITE_DATA32(u32Addr, u32Data)     (*((volatile unsigned int *)(((EBI==EBI_S)? EBI_BANK0_BASE_ADDR:EBI_BANK0_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
...
/**
  ...
  * \hideinitializer
  */
#define EBI1_READ_DATA8(u32Addr)                (*((volatile unsigned char *)(((EBI==EBI_S)? EBI_BANK1_BASE_ADDR:EBI_BANK1_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI1_WRITE_DATA8(u32Addr, u32Data)      (*((volatile unsigned char *)(((EBI==EBI_S)? EBI_BANK1_BASE_ADDR:EBI_BANK1_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
...
/**
  ...
  * \hideinitializer
  */
#define EBI1_READ_DATA16(u32Addr)               (*((volatile unsigned short *)(((EBI==EBI_S)? EBI_BANK1_BASE_ADDR:EBI_BANK1_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI1_WRITE_DATA16(u32Addr, u32Data)     (*((volatile unsigned short *)(((EBI==EBI_S)? EBI_BANK1_BASE_ADDR:EBI_BANK1_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
...
/**
  ...
  * \hideinitializer
  */
#define EBI1_READ_DATA32(u32Addr)               (*((volatile unsigned int *)(((EBI==EBI_S)? EBI_BANK1_BASE_ADDR:EBI_BANK1_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI1_WRITE_DATA32(u32Addr, u32Data)     (*((volatile unsigned int *)(((EBI==EBI_S)? EBI_BANK1_BASE_ADDR:EBI_BANK1_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
...
/**
  ...
  * \hideinitializer
  */
#define EBI2_READ_DATA8(u32Addr)                (*((volatile unsigned char *)(((EBI==EBI_S)? EBI_BANK2_BASE_ADDR:EBI_BANK2_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI2_WRITE_DATA8(u32Addr, u32Data)      (*((volatile unsigned char *)(((EBI==EBI_S)? EBI_BANK2_BASE_ADDR:EBI_BANK2_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
...
/**
  ...
  * \hideinitializer
  */
#define EBI2_READ_DATA16(u32Addr)               (*((volatile unsigned short *)(((EBI==EBI_S)? EBI_BANK2_BASE_ADDR:EBI_BANK2_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI2_WRITE_DATA16(u32Addr, u32Data)     (*((volatile unsigned short *)(((EBI==EBI_S)? EBI_BANK2_BASE_ADDR:EBI_BANK2_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
...
/**
  ...
  * \hideinitializer
  */
#define EBI2_READ_DATA32(u32Addr)               (*((volatile unsigned int *)(((EBI==EBI_S)? EBI_BANK2_BASE_ADDR:EBI_BANK2_BASE_ADDR_NS)+(u32Addr))))
...
/**
  ...
  * \hideinitializer
  */
#define EBI2_WRITE_DATA32(u32Addr, u32Data)     (*((volatile unsigned int *)(((EBI==EBI_S)? EBI_BANK2_BASE_ADDR:EBI_BANK2_BASE_ADDR_NS)+(u32Addr))) = (u32Data))
