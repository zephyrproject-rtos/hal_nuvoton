...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_RESET_FLAG(wdt)       ((wdt)->STATUS = WDT_STATUS_RSTF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_INT_FLAG(wdt) ((wdt)->STATUS = WDT_STATUS_IF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_WAKEUP_FLAG(wdt)  ((wdt)->STATUS = WDT_STATUS_WKF_Msk)
