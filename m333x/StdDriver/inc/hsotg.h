 ...
 * @file     hsotg.h
 * @version  V3.00
 * @brief    High Speed USB 2.0 On-The-Go(HSOTG) driver header file
 *
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_ENABLE() (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->CTL |= HSOTG_CTL_OTGEN_Msk):(HSOTG->CTL |= HSOTG_CTL_OTGEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_DISABLE() (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->CTL &= ~HSOTG_CTL_OTGEN_Msk):(HSOTG->CTL &= ~HSOTG_CTL_OTGEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_ENABLE_PHY() (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->PHYCTL |= HSOTG_PHYCTL_OTGPHYEN_Msk):(HSOTG->PHYCTL |= HSOTG_PHYCTL_OTGPHYEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_DISABLE_PHY() (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->PHYCTL &= ~HSOTG_PHYCTL_OTGPHYEN_Msk):(HSOTG->PHYCTL &= ~HSOTG_PHYCTL_OTGPHYEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_ENABLE_ID_DETECT() (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->PHYCTL |= HSOTG_PHYCTL_IDDETEN_Msk):(HSOTG->PHYCTL |= HSOTG_PHYCTL_IDDETEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_DISABLE_ID_DETECT() (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->PHYCTL &= ~HSOTG_PHYCTL_IDDETEN_Msk):(HSOTG->PHYCTL &= ~HSOTG_PHYCTL_IDDETEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_ENABLE_WAKEUP() (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->CTL |= HSOTG_CTL_WKEN_Msk):(HSOTG->CTL |= HSOTG_CTL_WKEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_DISABLE_WAKEUP() (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->CTL &= ~HSOTG_CTL_WKEN_Msk):(HSOTG->CTL &= ~HSOTG_CTL_WKEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_SET_VBUS_EN_POL(u32Pol) (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->PHYCTL = (HSOTG_NS->PHYCTL & (~HSOTG_PHYCTL_VBENPOL_Msk)) | ((u32Pol)<<HSOTG_PHYCTL_VBENPOL_Pos)):(HSOTG->PHYCTL = (HSOTG->PHYCTL & (~HSOTG_PHYCTL_VBENPOL_Msk)) | ((u32Pol)<<HSOTG_PHYCTL_VBENPOL_Pos)))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_SET_VBUS_STS_POL(u32Pol) (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->PHYCTL = (HSOTG_NS->PHYCTL & (~HSOTG_PHYCTL_VBSTSPOL_Msk)) | ((u32Pol)<<HSOTG_PHYCTL_VBSTSPOL_Pos)):(HSOTG->PHYCTL = (HSOTG->PHYCTL & (~HSOTG_PHYCTL_VBSTSPOL_Msk)) | ((u32Pol)<<HSOTG_PHYCTL_VBSTSPOL_Pos)))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_ENABLE_INT(u32Mask) (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->INTEN |= (u32Mask)):(HSOTG->INTEN |= (u32Mask)))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_DISABLE_INT(u32Mask) (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->INTEN &= ~(u32Mask)):(HSOTG->INTEN &= ~(u32Mask)))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_GET_INT_FLAG(u32Mask) (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->INTSTS & (u32Mask)):(HSOTG->INTSTS & (u32Mask)))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_CLR_INT_FLAG(u32Mask) (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->INTSTS = (u32Mask)):(HSOTG->INTSTS = (u32Mask)))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_GET_STATUS(u32Mask) (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->STATUS & (u32Mask)):(HSOTG->STATUS & (u32Mask)))
...
/**
  ...
  * \hideinitializer
  */
#define HSOTG_SET_PHY_REF_CLK(u32RefClock) (((__PC() & NS_OFFSET) == NS_OFFSET)? (HSOTG_NS->PHYCTL = (HSOTG_NS->PHYCTL & ~HSOTG_PHYCTL_FSEL_Msk) | (u32RefClock)):(HSOTG->PHYCTL = (HSOTG->PHYCTL & ~HSOTG_PHYCTL_FSEL_Msk) | (u32RefClock)))
