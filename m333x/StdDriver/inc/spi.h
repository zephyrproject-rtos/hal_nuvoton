...
/* SPI Status2 Mask */
#define SPI_SLVBENUM_MASK                (0x01UL)                         /*!< Effective bit number of uncompleted RX data status mask \hideinitializer */
...
#define SPII2S_SLAVE_ERR_INT_MASK           (0x80UL)                      /*!< Bit clock loss interrupt mask \hideinitializer */
