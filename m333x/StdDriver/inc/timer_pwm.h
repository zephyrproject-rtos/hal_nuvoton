...
#define TPWM_BRK_OUT_DISABLE                    (0UL)       /*!< Timer PWM output disable \hideinitializer */
#define TPWM_BRK_OUT_TRI_STATE                  (1UL)       /*!< Timer PWM output tri-state \hideinitializer */
#define TPWM_BRK_OUT_LOW                        (2UL)       /*!< Timer PWM output low \hideinitializer */    
#define TPWM_BRK_OUT_HIGH                       (3UL)       /*!< Timer PWM output high \hideinitializer */
...
#define TPWM_BRAKE_SOURCE_EDGE_SYS_RAM          (TIMER_PWMBRKCTL_SYSEBEN_Msk | (TIMER_PWMFAILBRK_RAMBRKEN_Msk << 16))    /*!< System fail condition: Secure SRAM parity error detection as edge-detect fault brake source \hideinitializer */
#define TPWM_BRAKE_SOURCE_EDGE_SYS_NSRAM        (TIMER_PWMBRKCTL_SYSEBEN_Msk | (TIMER_PWMFAILBRK_RAMNSBRKEN_Msk << 16))  /*!< System fail condition: Non-secure SRAM parity error detection as edge-detect fault brake source \hideinitializer */
#define TPWM_BRAKE_SOURCE_EDGE_SYS_ECC          (TIMER_PWMBRKCTL_SYSEBEN_Msk | (TIMER_PWMFAILBRK_FECCSBRKEN_Msk << 16))  /*!< System fail condition: Secure FMC ECC Double Error detection as edge-detect fault brake source \hideinitializer */
#define TPWM_BRAKE_SOURCE_EDGE_SYS_NSECC        (TIMER_PWMBRKCTL_SYSEBEN_Msk | (TIMER_PWMFAILBRK_FECCNSBRKEN_Msk << 16)) /*!< System fail condition: Non-secure FMC ECC Double Error detection as edge-detect fault brake source \hideinitializer */
...
#define TPWM_BRAKE_SOURCE_LEVEL_SYS_RAM         (TIMER_PWMBRKCTL_SYSLBEN_Msk | (TIMER_PWMFAILBRK_RAMBRKEN_Msk << 16))    /*!< System fail condition: Secure SRAM parity error detection as level-detect fault brake source \hideinitializer */
#define TPWM_BRAKE_SOURCE_LEVEL_SYS_NSRAM       (TIMER_PWMBRKCTL_SYSLBEN_Msk | (TIMER_PWMFAILBRK_RAMNSBRKEN_Msk << 16)   /*!< System fail condition: Non-secure SRAM parity error detection as level-detect fault brake source \hideinitializer */
#define TPWM_BRAKE_SOURCE_LEVEL_SYS_ECC         (TIMER_PWMBRKCTL_SYSLBEN_Msk | (TIMER_PWMFAILBRK_FECCSBRKEN_Msk << 16))  /*!< System fail condition: Secure FMC ECC Double Error detection as level-detect fault brake source \hideinitializer */
#define TPWM_BRAKE_SOURCE_LEVEL_SYS_NSECC       (TIMER_PWMBRKCTL_SYSLBEN_Msk | (TIMER_PWMFAILBRK_FECCNSBRKEN_Msk << 16)  /*!< System fail condition: Non-secure FMC ECC Double Error detection as level-detect fault brake source \hideinitializer */
