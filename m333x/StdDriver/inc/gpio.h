...
#endif
#if defined (SCU_INIT_IONSSET5_VAL) && (SCU_INIT_IONSSET5_VAL & BIT15 )
#define PF15              PF15_NS   /*!< Specify PF.15 Pin Data Input/Output */
#else
#define PF15              PF15_S    /*!< Specify PF.15 Pin Data Input/Output */
#endif
...
#define PF15_S           GPIO_PIN_DATA_S(5, 15) /*!< Specify PF.15 Pin Data Input/Output */
 ...
 *                          It could be BIT0 ~ BIT15 for PA, PB and PE GPIO port. \n
 *                          It could be BIT0 ~ BIT14 for PC and PD GPIO port. \n
 *                          It could be BIT0 ~ BIT11, BIT14 and BIT15 for PF GPIO port. \n
 ...
 *                              It could be 0 ~ 15 for PA, PB and PE GPIO port. \n
 *                              It could be 0 ~ 14 for PC and PD GPIO port. \n
 *                              It could be 0 ~ 11, 14, 15 for PF GPIO port. \n
