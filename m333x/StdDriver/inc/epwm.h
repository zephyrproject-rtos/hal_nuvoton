...
/*---------------------------------------------------------------------------------------------------------*/
#define EPWM_TRG_ADC_EVEN_ZERO                           (0U)     /*!< EPWM trigger EADC while counter of even channel matches zero point \hideinitializer */
#define EPWM_TRG_ADC_EVEN_PERIOD                         (1U)     /*!< EPWM trigger EADC while counter of even channel matches period point \hideinitializer */
#define EPWM_TRG_ADC_EVEN_ZERO_PERIOD                    (2U)     /*!< EPWM trigger EADC while counter of even channel matches zero or period point \hideinitializer */
#define EPWM_TRG_ADC_EVEN_COMPARE_UP                     (3U)     /*!< EPWM trigger EADC while counter of even channel matches up count to comparator point \hideinitializer */
#define EPWM_TRG_ADC_EVEN_COMPARE_DOWN                   (4U)     /*!< EPWM trigger EADC while counter of even channel matches down count to comparator point \hideinitializer */
#define EPWM_TRG_ADC_ODD_ZERO                            (5U)     /*!< EPWM trigger EADC while counter of odd channel matches zero point \hideinitializer */
#define EPWM_TRG_ADC_ODD_PERIOD                          (6U)     /*!< EPWM trigger EADC while counter of odd channel matches period point \hideinitializer */
#define EPWM_TRG_ADC_ODD_ZERO_PERIOD                     (7U)     /*!< EPWM trigger EADC while counter of odd channel matches zero or period point \hideinitializer */
#define EPWM_TRG_ADC_ODD_COMPARE_UP                      (8U)     /*!< EPWM trigger EADC while counter of odd channel matches up count to comparator point \hideinitializer */
#define EPWM_TRG_ADC_ODD_COMPARE_DOWN                    (9U)     /*!< EPWM trigger EADC while counter of odd channel matches down count to comparator point \hideinitializer */
#define EPWM_TRG_ADC_CH_0_FREE_CMP_UP                    (10U)    /*!< EPWM trigger EADC while counter of channel 0 matches up count to free comparator point \hideinitializer */
#define EPWM_TRG_ADC_CH_0_FREE_CMP_DOWN                  (11U)    /*!< EPWM trigger EADC while counter of channel 0 matches down count to free comparator point \hideinitializer */
#define EPWM_TRG_ADC_CH_2_FREE_CMP_UP                    (12U)    /*!< EPWM trigger EADC while counter of channel 2 matches up count to free comparator point \hideinitializer */
#define EPWM_TRG_ADC_CH_2_FREE_CMP_DOWN                  (13U)    /*!< EPWM trigger EADC while counter of channel 2 matches down count to free comparator point \hideinitializer */
#define EPWM_TRG_ADC_CH_4_FREE_CMP_UP                    (14U)    /*!< EPWM trigger EADC while counter of channel 4 matches up count to free comparator point \hideinitializer */
#define EPWM_TRG_ADC_CH_4_FREE_CMP_DOWN                  (15U)    /*!< EPWM trigger EADC while counter of channel 4 matches down count to free comparator point \hideinitializer */
#define EPWM_TRG_ADC_EVEN_IFA                            (16U)    /*!< EPWM trigger EADC while counter of even channel interrupt flag accumulator interrupt \hideinitializer */
#define EPWM_TRG_ADC_ODD_IFA                             (17U)    /*!< EPWM trigger EADC while counter of odd channel interrupt flag accumulator interrupt \hideinitializer */
...
#define EPWM_FB_EDGE_ADCRM0                       (EPWM_BRKCTL0_1_EADC0EBEN_Msk)   /*!< EADC0 Result Monitor (EADCRM) as edge-detect fault brake source \hideinitializer */
...
#define EPWM_FB_EDGE_SYS_RAM                      (EPWM_BRKCTL0_1_SYSEBEN_Msk | EPWM_FAILBRK_RAMBRKEN_Msk)    /*!< System fail condition: Secure SRAM parity error detection as edge-detect fault brake source \hideinitializer */
...
#define EPWM_FB_EDGE_SYS_NSRAM                    (EPWM_BRKCTL0_1_SYSEBEN_Msk | EPWM_FAILBRK_RAMNSBRKEN_Msk)  /*!< System fail condition: Non-secure SRAM parity error detection as edge-detect fault brake source \hideinitializer */
#define EPWM_FB_EDGE_SYS_ECC                      (EPWM_BRKCTL0_1_SYSEBEN_Msk | EPWM_FAILBRK_FECCSBRKEN_Msk)  /*!< System fail condition: Secure FMC ECC double error detection as edge-detect fault brake source \hideinitializer */
#define EPWM_FB_EDGE_SYS_NSECC                    (EPWM_BRKCTL0_1_SYSEBEN_Msk | EPWM_FAILBRK_FECCNSBRKEN_Msk) /*!< System fail condition: Non-secure FMC ECC double error detection as edge-detect fault brake source \hideinitializer */
...
#define EPWM_FB_LEVEL_ADCRM0                      (EPWM_BRKCTL0_1_EADC0LBEN_Msk)   /*!< EADC0 Result Monitor (EADCRM) as level-detect fault brake source \hideinitializer */
...
#define EPWM_FB_LEVEL_SYS_RAM                     (EPWM_BRKCTL0_1_SYSLBEN_Msk | EPWM_FAILBRK_RAMBRKEN_Msk)    /*!< System fail condition: Secure SRAM parity error detection as level-detect fault brake source \hideinitializer */
...
#define EPWM_FB_LEVEL_SYS_NSRAM                   (EPWM_BRKCTL0_1_SYSLBEN_Msk | EPWM_FAILBRK_RAMNSBRKEN_Msk)  /*!< System fail condition: Non-secure SRAM parity error detection as level-detect fault brake source \hideinitializer */
#define EPWM_FB_LEVEL_SYS_ECC                     (EPWM_BRKCTL0_1_SYSLBEN_Msk | EPWM_FAILBRK_FECCSBRKEN_Msk)  /*!< System fail condition: Secure FMC ECC double error detection as level-detect fault brake source \hideinitializer */
#define EPWM_FB_LEVEL_SYS_NSECC                   (EPWM_BRKCTL0_1_SYSLBEN_Msk | EPWM_FAILBRK_FECCNSBRKEN_Msk) /*!< System fail condition: Non-secure FMC ECC double error detection as level-detect fault brake source \hideinitializer */
 ...
 * @param[in]   epwm            The pointer of the specified EPWM module.
 * @param[in]   u32ChannelNum   EPWM channel number. Valid values are between 0~5.
 * @return      Return the clock prescaler of specified channel. Valid values are between 0~0xFFF.
