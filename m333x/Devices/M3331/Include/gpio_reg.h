...
typedef struct
{
    ...
    /**
     * @var GPIO_INT_T::INNF
     * Offset: 0x440/0x460/0x480/0x4a0/0x4c0/0x4e0/0x500/0x520  INT0~7 Input Noise Filter Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var GPIO_INT_T::EDETCTL
     * Offset: 0x444/0x464/0x484/0x4a4/0x4c4/0x4e4/0x504/0x524  INT0~7 Edge Detect Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var GPIO_INT_T::EDINTEN
     * Offset: 0x448/0x468/0x488/0x4a8/0x4c8/0x4e8/0x508/0x528  INT0~7 Edge Detect Interrupt Enable Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var GPIO_INT_T::EDSTS
     * Offset: 0x44c/0x46c/0c48c/0x4ac/0x4cc/0x4ec/0x50c/0x52c  INT0~7 Edge Detect Interrupt Flag Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |EDIF      |INT Edge Detect Interrupt Flag
     * |        |          |0 = No Edge Detection happened.
     * |        |          |1 = Rising Edge or Falling edge has been detected.
     * |        |          |Note: This bit is cleared by writing 1 to it.
     */

    __IO uint32_t INNF;     /* Offset: 0x440/0x460/0x480/0x4a0/0x4c0/0x4e0/0x500/0x520  INT0~7 Input Noise Filter Register   */
    __IO uint32_t EDETCTL;  /* Offset: 0x444/0x464/0x484/0x4a4/0x4c4/0x4e4/0x504/0x524  INT0~7 Edge Detect Control Register  */
    __IO uint32_t EDINTEN;  /* Offset: 0x448/0x468/0x488/0x4a8/0x4c8/0x4e8/0x508/0x528  INT0~7 Edge Detect Interrupt Enable Control Register                           */
    __IO uint32_t EDSTS;    /* Offset: 0x44c/0x46c/0c48c/0x4ac/0x4cc/0x4ec/0x50c/0x52c  INT0~7 Edge Detect Interrupt Flag Register                                     */
