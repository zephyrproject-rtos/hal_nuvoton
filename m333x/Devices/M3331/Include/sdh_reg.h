...
typedef struct
{
    ...
    /**
     * @var SDH_T::FB
     * Offset: 0x00~0x7C  Shared Buffer
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |SB        |SDH Shared Buffer
     ...
     * |        |          |Note 2: If target abort occurred, DMAEN will be cleared.
     ...
     * |        |          |0 = Scatter-Gather function Disabled (DMA will treat the starting address in SDH_DMASA as starting pointer of a single block memory).
     * |        |          |1 = Scatter-Gather function Enabled (DMA will treat the starting address in SDH_DMASA as a starting address of Physical Address Descriptor (PAD) table
     ...
     * |        |          |0 = No effect. (Please use CTLRST (SDH_CTL[14]) to clear this bit.)
     * |        |          |1 = Enabled. The SD host will output a command to SD card.
     ...
     * |        |          |0 = No effect. (Please use CTLRST (SDH_CTL[14]) to clear this bit.)
     * |        |          |1 = Enabled. The SD host will wait to receive a response from SD card.
     * |        |          |Note: When operation is finished, this bit will be cleared automatically, so don't write 0 to this bit (the controller will be abnormal).
     * |[2]     |DIEN      |Data Input Enable Bit
     * |        |          |0 = No effect. (Please use CTLRST (SDH_CTL[14]) to clear this bit.)
     * |        |          |1 = Enabled. The SD host will wait to receive block data and the CRC16 value from SD card.
     * |        |          |Note: When operation is finished, this bit will be cleared automatically, so don't write 0 to this bit (the controller will be abnormal).
     * |[3]     |DOEN      |Data Output Enable Bit
     * |        |          |0 = No effect. (Please use CTLRST (SDH_CTL[14]) to clear this bit.)
     * |        |          |1 = Enabled. The SD host will transfer block data and the CRC16 value to SD card.
     * |        |          |Note: When operation is finished, this bit will be cleared automatically, so don't write 0 to this bit (the controller will be abnormal).
     * |[4]     |R2EN      |Response R2 Input Enable Bit
     * |        |          |0 = No effect. (Please use CTLRST (SDH_CTL[14]) to clear this bit.)
     * |        |          |1 = Enabled. The SD host will wait to receive a response R2 from SD card and store the response data into DMA's Flash buffer (exclude CRC7).
     * |        |          |Note: When operation is finished, this bit will be cleared automatically, so don't write 0 to this bit (the controller will be abnormal).
     * |[5]     |CLK74OEN  |Initial 74 Clock Cycles Output Enable Bit
     * |        |          |0 = No effect. (Please use CTLRST (SDH_CTL[14]) to clear this bit.)
     * |        |          |1 = Enabled. The SD host will output 74 clock cycles to SD card.
     * |        |          |Note: When operation is finished, this bit will be cleared automatically, so don't write 0 to this bit (the controller will be abnormal).
     * |[6]     |CLK8OEN   |Generating 8 Clock Cycles Output Enable Bit
     * |        |          |0 = No effect. (Please use CTLRST (SDH_CTL[14]) to clear this bit.)
     * |        |          |1 = Enabled. The SD host will output 8 clock cycles.
     * |        |          |Note: When operation is finished, this bit will be cleared automatically, so don't write 0 to this bit (the controller will be abnormal).
     ...
     * |[15]    |DBW       |SD Data Bus Width Selection
     ...
     * |        |          |0 = CDIF (SDH_INTSTS[8]) trigger interrupt Disabled.
     ...
     * |        |          |0 = RTOIF (SDH_INTSTS[12]) trigger interrupt Disabled.
     ...
     * |        |          |Time-out value is specified at TOUT register.
     * |        |          |0 = DITOIF (SDH_INTSTS[13]) trigger interrupt Disabled.
     * |        |          |1 = DITOIF (SDH_INTSTS[13]) trigger interrupt Enabled.
     ...
     * |        |          |In this condition, software should ignore CRC error and clear this bit manually.
     ...
     * |        |          |If that response does not contain CRC7 information (e.g.
     ...
     * |[7]     |DAT0STS   |DAT0 Pin Status of Current Selected SD Card (Read Only)
     * |        |          |This bit is the DAT0 pin status of current selected SD card.
     ...
     * |        |          |0 = Card inserted.
     * |        |          |1 = Card removed.
     * |[18]    |DAT1STS   |DAT1 Pin Status of SD Card (Read Only)
    ...
    __IO uint32_t FB[32];                /*!< [0x0000] Shared Buffer                                                    */
    /// @cond HIDDEN_SYMBOLS
...
#define SDH_FB_SB_Pos                    (0)                                               /*!< SDH_T::FB: SB Position                 */
#define SDH_FB_SB_Msk                    (0xfffffffful << SDH_FB_n_SB_Pos)                 /*!< SDH_T::FB: SB Mask                     */
