...
typedef struct
{
     ...
     * |        |          |0 = No effect.
     * |        |          |1 = Starts CRC DMA transfer or indicates the CRC DMA is operating.
     * |        |          |Note1: This bit is read-as-1 when the CRC DMA is operating.
     * |        |          |Note2: This bit can be set to 1 when all DMASTS flags are cleared to zero.
     * |[1]     |PAUSE     |CRC DMA Pause Bit
     * |        |          |Set CRC DMA to pause the operation.
     * |        |          |0 = Continue the CRC DMA operation when CRC DMA is under operation.
     * |        |          |1 = Pause the CRC DMA operation.
     * |        |          |Note1: This bit is read-as-1 when the CRC DMA is paused.
     * |        |          |Note2: This bit can be set to 1 when the CRC DMA is operating.
     * |[4]     |ABORT     |CRC DMA Operation Abort Bit
     * |        |          |Write 1 to abort the operation of CRC DMA.
     * |        |          |0 = No effect.
     * |        |          |1 = Abote the CRC DMA operation.
     * |[8]     |INTEN     |CRC DMA Mode Interrupt Enable Bit
     * |        |          |Enable CRC DMA mode interrupt.
     * |        |          |0 = CRC DMA interrupt Disabled.
     * |        |          |1 = CRC DMA interrupt Enabled.
     * |[9]     |INCR4EN   |CRC DMA INCR4 Burst Mode Enable Bit
     * |        |          |0 = Single transfer type.
     * |        |          |1 = Burst INCR4 transfer enabled.
     * |        |          |Note: Only 4 words-aligned transfer if INCR4 bit enabled, other transfer is single type.
     * @var CRC_T::DMASTS
     * Offset: 0x44  CRC DMA Operation Status Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |FINISH    |DMA Operation Finish Flag
     * |        |          |Indicates the operation of DMA mode finished successfully.
     * |        |          |0 = DMA operation is not finish.
     * |        |          |1 = DMA operation is finished.
     * |        |          |Note: This bit is cleared by writing 1 to it.
     * |[1]     |ABORTED   |DMA Operation Aborted Flag
     * |        |          |Indicates the operation of DMA mode is aborted to due to set ABORT bit (CRC_DMACTL[4] = 1).   
     * |        |          |0 = DMA operation is not abort.
     * |        |          |1 = DMA operation is aborted.
     * |        |          |Note: This bit is cleared by writing 1 to it.
     * |[2]     |CFGERR    |DMA Configuration Error Flag
     * |        |          |Indicates the configuration to run DMA operation is invalid and the operation of DMA mode is canceled.
     * |        |          |0 = No configuration error in the CRC DMA operation.
     * |        |          |1 = Configuration error in CRC DMA operation.
     * |        |          |Note: This bit is cleared by writing 1 to it.
     * |[3]     |ACCERR    |DMA Access Error Flag
     * |        |          |Indicates the operation of DMA mode is aborted due to access error.
     * |        |          |0 = No access error in the CRC DMA operation.
     * |        |          |1 = Access error in CRC DMA operation.
     * |        |          |Note: This bit is cleared by writing 1 to it.
     * @var CRC_T::SADDR
     ...
     * |        |          |Indicates word counts for CRC DMA to read.
    ...
    __IO uint32_t DMASTS;                /*!< [0x0044] CRC DMA Operation Status Register                                */
