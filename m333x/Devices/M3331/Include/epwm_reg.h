...
typedef struct
{
     ...
     * |[2]     |RAMBRKEN  |Secure SRAM Parity Error Detection Trigger EPWM Brake Function Enable Bit
     ...
     * |[4]     |RAMNSBRKEN     |Non-secure SRAM Parity Error Detection Trigger EPWM Brake Function Enable Bit
     ...
     * |[5]     |FECCSBRKEN     |Secure FMC ECC Double Error Detection Trigger EPWM Brake Function Enable Bit
     ...
     * |[6]     |FECCNSBRKEN    |Non-secure FMC ECC Double Error Detection Trigger EPWM Brake Function Enable Bit
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |FDEN0     |EPWM Channel n Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[1]     |FDEN1     |EPWM Channel n Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[2]     |FDEN2     |EPWM Channel n Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[3]     |FDEN3     |EPWM Channel n Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[4]     |FDEN4     |EPWM Channel n Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[5]     |FDEN5     |EPWM Channel n Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     ...
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * @var EPWM_T::PBUF[6]
     * Offset: 0x304  EPWM PERIOD0~5 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EPWM_T::CMPBUF[6]
     * Offset: 0x31C  EPWM CMPDAT0~5 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * Offset: 0x334  EPWM CLKPSC0_1/2_3/4_5 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EPWM_T::FTCBUF[3]
     * Offset: 0x340  EPWM FTCMPDAT0_1/2_3/4_5 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Software can clear this bit by writing 1 to it.
     * @var EPWM_T::CPSCBUF0
     * Offset: 0x350  EPWM CLKPSC0 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     ...
     * @var EPWM_T::CPSCBUF1
     * Offset: 0x354  EPWM CLKPSC1 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::CPSCBUF2
     * Offset: 0x358  EPWM CLKPSC2 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::CPSCBUF3
     * Offset: 0x35C  EPWM CLKPSC3 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::CPSCBUF4
     * Offset: 0x360  EPWM CLKPSC4 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::CPSCBUF5
     * Offset: 0x364  EPWM CLKPSC5 Buffer Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::IFACNT0
     * Offset: 0x368  EPWM Interrupt Flag Accumulator Counter 0 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EPWM_T::IFACNT1
     * Offset: 0x36C  EPWM Interrupt Flag Accumulator Counter 1 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
     * |        |          |This value indicates how many interrupt are accumulated when using interrupt flag accumulator function.
     * @var EPWM_T::IFACNT2
     * Offset: 0x370  EPWM Interrupt Flag Accumulator Counter 2 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
     * |        |          |This value indicates how many interrupt are accumulated when using interrupt flag accumulator function.
     * @var EPWM_T::IFACNT3
     * Offset: 0x374  EPWM Interrupt Flag Accumulator Counter 3 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
     * |        |          |This value indicates how many interrupt are accumulated when using interrupt flag accumulator function.
     * @var EPWM_T::IFACNT4
     * Offset: 0x378  EPWM Interrupt Flag Accumulator Counter 4 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
     * |        |          |This value indicates how many interrupt are accumulated when using interrupt flag accumulator function.
     * @var EPWM_T::IFACNT5
     * Offset: 0x37C  EPWM Interrupt Flag Accumulator Counter 5 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
    ...
    __IO uint32_t FDCTL[6];              /*!< [0x0164] EPWM Fault Detect Control Register 0~5                            */
    ...
    __IO uint32_t CAPNF[6];              /*!< [0x0258] EPWM Capture Input Noise Filter Register 0~5                      */
    __IO uint32_t EXTETCTL[6];           /*!< [0x0270] EPWM External Event Trigger Control Register 0~5                  */
    ...
    __IO uint32_t CLKPSC[6];             /*!< [0x0290] EPWM Clock Prescale Register 0~5                                  */
    __IO uint32_t RDTCNT[3];             /*!< [0x02a8] EPWM Rising Dead-time Counter Register 0/1, 2/3, 4/5              */
    __IO uint32_t FDTCNT[3];             /*!< [0x02b4] EPWM Falling Dead-time Counter Register 0/1, 2/3, 4/5             */
    __IO uint32_t DTCTL;                 /*!< [0x02c0] EPWM Dead-Time Control Register                                   */
    /// @cond HIDDEN_SYMBOLS
    __I  uint32_t RESERVE13[16];
    /// @endcond //HIDDEN_SYMBOLS
    __I  uint32_t PBUF[6];               /*!< [0x0304] EPWM PERIOD0~5 Buffer Register                                    */
    __I  uint32_t CMPBUF[6];             /*!< [0x031c] EPWM CMPDAT0~5 Buffer Register                                    */
    /// @cond HIDDEN_SYMBOLS
    __I  uint32_t RESERVE14[3];
    /// @endcond //HIDDEN_SYMBOLS
    __I  uint32_t FTCBUF[3];             /*!< [0x0340] EPWM FTCMPDAT0_1/2_3/4_5 Buffer Register                          */
    __IO uint32_t FTCI;                  /*!< [0x034c] EPWM FTCMPDAT Indicator Register                                  */
    __I  uint32_t CPSCBUF[6];            /*!< [0x0350] EPWM CLKPSC0~5 Buffer Register                                    */
    __I  uint32_t IFACNT[6];             /*!< [0x0368] EPWM Interrupt Flag Accumulator Counter 0~5 Register              */
...
#define EPWM_FAILBRK_RAMNSBRKEN_Pos       (4)                                               /*!< EPWM_T::FAILBRK: RAMNSBRKEN Position     */
#define EPWM_FAILBRK_RAMNSBRKEN_Msk       (0x1ul << EPWM_FAILBRK_RAMNSBRKEN_Pos)            /*!< EPWM_T::FAILBRK: RAMNSBRKEN Mask         */

#define EPWM_FAILBRK_FECCSBRKEN_Pos       (5)                                               /*!< EPWM_T::FAILBRK: FECCSBRKEN Position      */
#define EPWM_FAILBRK_FECCSBRKEN_Msk       (0x1ul << EPWM_FAILBRK_FECCSBRKEN_Pos)            /*!< EPWM_T::FAILBRK: FECCSBRKEN Mask          */

#define EPWM_FAILBRK_FECCNSBRKEN_Pos      (6)                                               /*!< EPWM_T::FAILBRK: FECCNSBRKEN Position     */
#define EPWM_FAILBRK_FECCNSBRKEN_Msk      (0x1ul << EPWM_FAILBRK_FECCNSBRKEN_Pos)           /*!< EPWM_T::FAILBRK: FECCNSBRKEN Mask         */
