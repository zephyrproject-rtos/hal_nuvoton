...
typedef struct
{
     ...
     * |        |          |1 = Capture Function source is from internal ACMP output signal, internal clock source (HIRC, LIRC) or external clock (HXT, LXT).
     ...
     * |        |          |When CAPEN (TIMERx_EXTCTL[3]) bit is set, , the transition on the capture source matches the CAPEDGE (TIMERx_EXTCTL[14:12]) setting, CAPIF (TIMERx_EINTSTS[0]) will be set to 1 and the current timer counter value CNT (TIMERx_CNT[23:0]) will be auto-loaded into this CAPDAT field.
     * @var TIMER_T::EXTCTL
     ...
     * |        |          |Note2: When CAPFUNCS is 1 and CAPIF becomes 1, the current 24-bit timer counter value (CNT value) will be saved to CAPDAT field then CNT value will be reset to 0 immediately.
     ...
     * |        |          |Note: CAPIEN is used to enable timer capture interrupt. If CAPIEN enabled, timer will rise an interrupt when CAPIF (TIMERx_EINTSTS[0]) is 1.
     ...
     * |[17:16] |ECNTSSEL  |Event Counter Source Selection to Trigger Event Counter Function
     * |        |          |00 = Event Counter input source is from external TMx (x=0~3) pin.
     * |        |          |01 = Event Counter input source is from internal USB SOF output signal.
     * |        |          |10 = Event Counter input source is from internal ACMP0 output signal.
     * |        |          |11 = Event Counter input source is from internal ACMP1 output signal.
     ...
     * |        |          |0 = TMx_EXT (x=0~3) pin, ACMP, internal clock, or external clock capture interrupt did not occur.
     * |        |          |1 = TMx_EXT (x=0~3) pin, ACMP, internal clock, or external clock capture interrupt occurred.
     * |        |          |Note1: This bit is cleared by writing 1 to it.
     * |        |          |Note2: When CAPEN (TIMERx_EXTCTL[3]) bit is set, the transition on the capture source matches the CAPEDGE (TIMERx_EXTCTL[14:12]) setting, this bit will be set to 1 by hardware.
     ...
     * |        |          |0 = Time-out interrupt signal is used to internal trigger EPWM, BPWM, PDMA, and EADC.
     * |        |          |1 = Capture interrupt signal is used to internal trigger EPWM, BPWM, PDMA, and EADC.
     ...
     * |        |          |1 = PERIOD/CMP will load to PBUF/CMPBUF immediately when user writes PERIOD/CMP and current counter count is completed.
     ...
     * |[2]     |RAMBRKEN  |Secure SRAM Parity Error Detection Trigger PWM Brake Function Enable Bit
     * |        |          |0 = Brake Function triggered by Secure SRAM parity error detection Disabled.
     * |        |          |1 = Brake Function triggered by Secure SRAM parity error detection Enabled.
     ...
     * |[4]     |RAMNSBRKEN     |Non-secure SRAM Parity Error Detection Trigger PWM Brake Function Enable Bit
     * |        |               |0 = Brake Function triggered by Non-secure SRAM parity error detection Disabled.
     * |        |               |1 = Brake Function triggered by Non-secure SRAM parity error detection Enabled.
     * |[5]     |FECCSBRKEN     |Secure FMC ECC Double Error Detection Trigger PWM Brake Function Enable Bit
     * |        |               |0 = Brake Function triggered by Secure FMC ECC double error detection Disabled.
     * |        |               |1 = Brake Function triggered by Secure FMC ECC double error detection Enabled.
     * |[6]     |FECCNSBRKEN    |Non-secure FMC ECC Double Error Detection Trigger PWM Brake Function Enable Bit
     * |        |               |0 = Brake Function triggered by Non-secure FMC ECC double error detection Disabled.
     * |        |               |1 = Brake Function triggered by Non-secure FMC ECC double error detection Enabled.
     ...
     * |        |          |Note2: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[4]     |BRKPEEN   |Enable PWMx_BRAKEy Pin As Edge-detect Brake Source (Write Protect)
     ...
     * |        |          |Note1: Only internal ACMP1_O signal from low to high will be detected as brake event.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[12]    |BRKPLEN   |Enable PWMx_BRAKEy Pin As Level-detect Brake Source (Write Protect)
     ...
     * |        |          |Note1: If CMP is equal to PERIOD, there is no CMPUIF flag in up count type and up-down count type.
     * |        |          |Note2: This bit is cleared by writing 1 to it.
     ...
     * |        |          |Note1: If CMP is equal to PERIOD, there is no CMPDIF flag in down count type.
     * |        |          |Note2: This bit is cleared by writing 1 to it.
     ...
     * |        |          |0 = Counter synchronous start/clear by trigger TIMER0_PWMSTRG STRGEN bit.
     * |        |          |1 = Counter synchronous start/clear by trigger TIMER2_PWMSTRG STRGEN bit.
     ...
     * |        |          |0 = PWM counter event trigger EADC start conversion did not occurred.
     * |        |          |1 = PWM counter event trigger EADC start conversion occurred.
     * |        |          |Note: This bit is cleared by writing 1 to it.
     * @var TIMER_T::PWMPBUF
...
#define TIMER_PWMFAILBRK_RAMNSBRKEN_Pos  (4)                                               /*!< TIMER_T::PWMFAILBRK: RAMNSBRKEN Position */
#define TIMER_PWMFAILBRK_RAMNSBRKEN_Msk  (0x1ul << TIMER_PWMFAILBRK_RAMNSBRKEN_Pos)        /*!< TIMER_T::PWMFAILBRK: RAMNSBRKEN Mask     */

#define TIMER_PWMFAILBRK_FECCSBRKEN_Pos  (5)                                               /*!< TIMER_T::PWMFAILBRK: FECCSBRKEN Position */
#define TIMER_PWMFAILBRK_FECCSBRKEN_Msk  (0x1ul << TIMER_PWMFAILBRK_FECCSBRKEN_Pos)        /*!< TIMER_T::PWMFAILBRK: FECCSBRKEN Mask     */

#define TIMER_PWMFAILBRK_FECCNSBRKEN_Pos (6)                                               /*!< TIMER_T::PWMFAILBRK: FECCNSBRKEN Position */
#define TIMER_PWMFAILBRK_FECCNSBRKEN_Msk (0x1ul << TIMER_PWMFAILBRK_FECCNSBRKEN_Pos)       /*!< TIMER_T::PWMFAILBRK: FECCNSBRKEN Mask     */
