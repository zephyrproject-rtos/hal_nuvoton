...
typedef struct
{
     ...
     * |        |          |This bit will be also cleared if VBUSDROP (HSOTG_CTL[0]) bit is set IDSTS (HSOTG_STATUS[1]) changed.
     ...
     * |        |          |Selects OTG PHY reference clock frequency which is from HXT.
     * |        |          |000 = Reference clock is 9.6 MHz.
     * |        |          |001 = Reference clock is 10 MHz.
     * |        |          |010 = Reference clock is 12 MHz.
     * |        |          |011 = Reference clock is 19.2 MHz.
     * |        |          |100 = Reference clock is 20 MHz.
     * |        |          |101 = Reference clock is 24 MHz.
     * |        |          |111 = Reference clock is 50 MHz.
     * @var HSOTG_T::INTEN
     ...
     * |        |          |If this bit is set to 1 and IDSTS (HSOTG_STATUS[1]) status is changed from high to low or from low to high, a interrupt will be asserted.
     * |        |          |0 = Interrupt Disabled.
     * |        |          |1 = Interrupt Enabled.
     ...
     * |        |          |If this bit is set to 1 and BVLD (HSOTG_STATUS[3]) status is changed from high to low or from low to high, a interrupt will be asserted.
     * |        |          |0 = Interrupt Disabled.
     * |        |          |1 = Interrupt Enabled.
     * |[9]     |AVLDCHGIEN|A-device Session Valid Status Changed Interrupt Enable Bit
     * |        |          |If this bit is set to 1 and AVLD (HSOTG_STATUS[4]) status is changed from high to low or from low to high, a interrupt will be asserted.
     * |        |          |0 = Interrupt Disabled.
     * |        |          |1 = Interrupt Enabled.
     * |[10]    |VBCHGIEN  |VBUSVLD Status Changed Interrupt Enable Bit
     * |        |          |If this bit is set to 1 and VBUSVLD (HSOTG_STATUS[5]) status is changed from high to low or from low to high, a interrupt will be asserted.
     * |        |          |0 = Interrupt Disabled.
     * |        |          |1 = Interrupt Enabled.
     * |[11]    |SECHGIEN  |SESSEND Status Changed Interrupt Enable Bit
     * |        |          |If this bit is set to 1 and SESSEND (HSOTG_STATUS[2]) status is changed from high to low or from low to high, a interrupt will be asserted.
     * |        |          |0 = Interrupt Disabled.
     * |        |          |1 = Interrupt Enabled.
     ...
     * |        |          |0 = BVLD (HSOTG_STATUS[3]) is not toggled.
