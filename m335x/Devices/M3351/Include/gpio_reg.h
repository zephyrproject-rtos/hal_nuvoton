...
typedef struct
{
     ...
     * |        |          |Note 1:
     * |        |          |Max. n=15 for port A/B/D/E.
     * |        |          |Max. n=14 for port C.
     * |        |          |n=0~11, or 14 for port F.
     * |        |          |n=2~4, or 9~15 for port G.
     * |        |          |n=4~11 for port H.
     * @var GPIO_T::DINOFF
     ...
     * |        |          |n=4~11 for port H.
     * @var GPIO_T::INTTYPE
     * Offset: 0x18/0x58/0x98/0xD8/0x118/0x158/0x198/0x1D8/0x208/0x258  Port A-H Interrupt Trigger Type Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
...
typedef struct
{
    /**
     * @var EINT_T::INNF
     * Offset: 0x440/0x460/0x480/0x4a0/0x4c0/0x4e0/0x500/0x520  EINT[n] Input Noise Filter Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EINT_T::EDETCTL
     * Offset: 0x444/0x464/0x484/0x4a4/0x4c4/0x4e4/0x504/0x524  EINT[n] Edge Detect Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EINT_T::EDINTEN
     * Offset: 0x448/0x468/0x488/0x4a8/0x4c8/0x4e8/0x508/0x528  EINT[n] Edge Detect Interrupt Enable Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EINT_T::EDSTS
     * Offset: 0x44c/0x46c/0x48c/0x4ac/0x4cc/0x4ec/0x50c/0x52c  EINT[n] Edge Detect Interrupt Flag Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     */
    __IO uint32_t INNF;     /* Offset: 0x440/0x460/0x480/0x4a0/0x4c0/0x4e0/0x500/0x520 EINT[n] Input Noise Filter Register                                             */
    __IO uint32_t EDETCTL;  /* Offset: 0x444/0x464/0x484/0x4a4/0x4c4/0x4e4/0x504/0x524 EINT[n] Edge Detect Control Register                                            */
    __IO uint32_t EDINTEN;  /* Offset: 0x448/0x468/0x488/0x4a8/0x4c8/0x4e8/0x508/0x528 EINT[n] Edge Detect Interrupt Enable Control Register                           */
    __IO uint32_t EDSTS;    /* Offset: 0x44c/0x46c/0x48c/0x4ac/0x4cc/0x4ec/0x50c/0x52c EINT[n] Edge Detect Interrupt Flag Register                                     */
    /// @cond HIDDEN_SYMBOLS
