...
typedef struct
{
     ...
     * |        |          |In up-down counter type, PERIOD will be loaded to PBUF at the end point of each period
     * |        |          |CMPDAT will be loaded to CMPBUF at the center point of a period
     ...
     * |        |          |In up-down counter type, PERIOD will be loaded to PBUF at the end point of each period
     * |        |          |CMPDAT will be loaded to CMPBUF at the center point of a period
     * |[16]    |IMMLDEN0  |Immediately Load Enable Bit
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |0 = PERIOD will be loaded to PBUF at the end point of each period
     * |        |          |CMPDAT will be loaded to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMPDAT will be loaded to PBUF and CMPBUF immediately when software update PERIOD/CMPDAT.
     * |        |          |Note: If IMMLDENn is enabled, CTRLDn will be invalid.
     * |[17]    |IMMLDEN1  |Immediately Load Enable Bit
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |0 = PERIOD will be loaded to PBUF at the end point of each period
     * |        |          |CMPDAT will be loaded to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMPDAT will be loaded to PBUF and CMPBUF immediately when software update PERIOD/CMPDAT.
     * |        |          |Note: If IMMLDENn is enabled, CTRLDn will be invalid.
     * |[18]    |IMMLDEN2  |Immediately Load Enable Bit
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |0 = PERIOD will be loaded to PBUF at the end point of each period
     * |        |          |CMPDAT will be loaded to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMPDAT will be loaded to PBUF and CMPBUF immediately when software update PERIOD/CMPDAT.
     * |        |          |Note: If IMMLDENn is enabled, CTRLDn will be invalid.
     * |[19]    |IMMLDEN3  |Immediately Load Enable Bit
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |0 = PERIOD will be loaded to PBUF at the end point of each period
     * |        |          |CMPDAT will be loaded to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMPDAT will be loaded to PBUF and CMPBUF immediately when software update PERIOD/CMPDAT.
     * |        |          |Note: If IMMLDENn is enabled, CTRLDn will be invalid.
     * |[20]    |IMMLDEN4  |Immediately Load Enable Bit
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |0 = PERIOD will be loaded to PBUF at the end point of each period
     * |        |          |CMPDAT will be loaded to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMPDAT will be loaded to PBUF and CMPBUF immediately when software update PERIOD/CMPDAT.
     * |        |          |Note: If IMMLDENn is enabled, CTRLDn will be invalid.
     * |[21]    |IMMLDEN5  |Immediately Load Enable Bit
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |0 = PERIOD will be loaded to PBUF at the end point of each period
     * |        |          |CMPDAT will be loaded to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMPDAT will be loaded to PBUF and CMPBUF immediately when software update PERIOD/CMPDAT.
     ...
     * |        |          |000 = BPWMx_CLK, x denotes 0 or 3.
     * |        |          |001 = TIMER0 overflow.
     * |        |          |010 = TIMER1 overflow.
     * |        |          |011 = TIMER2 overflow.
     * |        |          |100 = TIMER3 overflow.
     ...
     * |        |          |11 = BPWM zero point output Toggle.
     * |        |          |Note: BPWM can control output level when BPWM counter counts to 0.
     * |[17:16] |PRDPCTL0  |BPWM Period Point Control
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |00 = Do nothing.
     ...
     * |[19:18] |PRDPCTL1  |BPWM Period Point Control
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |00 = Do nothing.
     * |        |          |01 = BPWM period (center) point output Low.
     * |        |          |10 = BPWM period (center) point output High.
     ...
     * |        |          |BPWM can control output level when BPWM counter count to (PERIOD+1).
     * |        |          |Note: This bit is center point control when BPWM counter operating in up-down counter type.
     * |[21:20] |PRDPCTL2  |BPWM Period Point Control
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |00 = Do nothing.
     * |        |          |01 = BPWM period (center) point output Low.
     * |        |          |10 = BPWM period (center) point output High.
     ...
     * |        |          |BPWM can control output level when BPWM counter count to (PERIOD+1).
     * |        |          |Note: This bit is center point control when BPWM counter operating in up-down counter type.
     * |[23:22] |PRDPCTL3  |BPWM Period Point Control
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |00 = Do nothing.
     * |        |          |01 = BPWM period (center) point output Low.
     * |        |          |10 = BPWM period (center) point output High.
     ...
     * |        |          |BPWM can control output level when BPWM counter count to (PERIOD+1).
     * |        |          |Note: This bit is center point control when BPWM counter operating in up-down counter type.
     * |[25:24] |PRDPCTL4  |BPWM Period Point Control
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |00 = Do nothing.
     * |        |          |01 = BPWM period (center) point output Low.
     * |        |          |10 = BPWM period (center) point output High.
     ...
     * |        |          |BPWM can control output level when BPWM counter count to (PERIOD+1).
     * |        |          |Note: This bit is center point control when BPWM counter operating in up-down counter type.
     * |[27:26] |PRDPCTL5  |BPWM Period Point Control
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |00 = Do nothing.
     * |        |          |01 = BPWM period (center) point output Low.
     * |        |          |10 = BPWM period (center) point output High.
     ...
     * |        |          |This data bit controls the state of BPWMn output pin if the corresponding mask function is enabled
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     ...
     * |        |          |Note: If CMPDAT is equal to PERIOD, this flag will not work in up counter type selection.
     ...
     * |        |          |Software can clear this bit by writing 1 to it.
     * |        |          |Note: If CMPDAT is equal to PERIOD, this flag will not work in down counter type selection.
     ...
     * |        |          |0 = BPWM_CH0 Trigger EADC function Disabled.
     * |        |          |1 = BPWM_CH0 Trigger EADC function Enabled.
     ...
     * |        |          |0 = BPWM_CH1 Trigger EADC function Disabled.
     * |        |          |1 = BPWM_CH1 Trigger EADC function Enabled.
     ...
     * |        |          |0 = BPWM_CH2 Trigger EADC function Disabled.
     * |        |          |1 = BPWM_CH2 Trigger EADC function Enabled.
     ...
     * |        |          |0 = BPWM_CH3 Trigger EADC function Disabled.
     * |        |          |1 = BPWM_CH3 Trigger EADC function Enabled.
     * @var BPWM_T::EADCTS1
     ...
     * |        |          |0 = BPWM_CH4 Trigger EADC function Disabled.
     * |        |          |1 = BPWM_CH4 Trigger EADC function Enabled.
     ...
     * |        |          |0 = BPWM_CH5 Trigger EADC function Disabled.
     * |        |          |1 = BPWM_CH5 Trigger EADC function Enabled.
     * @var BPWM_T::SSCTL
     ...
     * |        |          |10 = Synchronous start source come from BPWM.
     ...
     * |        |          |1 = An EADC start of conversion trigger event occurred. Software can write 1 to clear this bit.
     ...
     * |        |          |Each bit n controls the corresponding BPWM channel n.
     * |        |          |0 = Capture function Disabled. BPWM_RCAPDATn/BPWM_FCAPDATn register will not be updated.
     ...
     * |        |          |Note: This bit will be cleared automatically when user clears corresponding CAPRIF.
     ...
     * |        |          |Note: This bit will be cleared automatically when user clears corresponding CAPFIF.
...
#define BPWM_STATUS_CNTMAX0_Pos        (0)                                               /*!< BPWM_T::STATUS: CNTMAXF0 Position     */
#define BPWM_STATUS_CNTMAX0_Msk        (0x1ul << BPWM_STATUS_CNTMAX0_Pos)              /*!< BPWM_T::STATUS: CNTMAXF0 Mask         */
