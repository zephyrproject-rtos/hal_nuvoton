...
typedef struct
{
     ...
     * |        |          |110 = WDT0 hardware enable function is active
     * |        |          |WDTPDIS be forced as 0 and user cannot change this bit to 1.
     * |        |          |Others = WDT0 hardware enable function is active
     * |        |          |WDTPDIS be set as 0 and user can change this bit to 1.
     * |        |          |Note: Only WDT0 supports hardware enable function.
